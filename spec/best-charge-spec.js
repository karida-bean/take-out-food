 ...
 describe("",function(){
  ...
  describe("",function() {
    it('should get cartItems count', function () {
      ...
      let cartItemsCounts = getCartItemsCount(inputs);
      let expected = [{id: ITEM0001, count: 3}, {id: ITEM00022, count: 1}];
      expcet(cartItemsCounts).toEqual(expected)
    })
  })
...
describe("getCartItemPromotion",function() {
  it('should get cartItemPromotion', function () {
    ...
    let inputs2 = [{type: '满30减6元'}, {type: '指定菜品半价', items: ['ITEM0001', 'ITEM0022']}];
    let promotionTypes = getCartItemPromotion(inputs1, inputs2);
    let expected = [{id: 'ITEM0001', name: '黄焖鸡', price: 18.00, count: 3, type: '满30减6元'}, {
      id: 'ITEM0022',
      name: '凉皮',
      price: 8.00,
      count: 1,
...
describe("getPromtionMoney",function() {
  it('should get promotionMoney', function () {
    ...
    let expected = [{
      ...
      type: '满30减6元',
      proMoney: 0
    }, {id: 'ITEM0022', name: '凉皮', price: 8.00, count: 1, type: '指定菜品半价', proMoney: 4}];
